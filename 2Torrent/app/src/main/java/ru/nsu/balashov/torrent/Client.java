...
public class Client {
    ...
    public void newDownload(ArrayList<String> ipWithPortList, ByteBuffer infoHash) {
    ...
    public void addSources(ByteBuffer infoHash, ArrayList<String> ipWithPortsList) {
